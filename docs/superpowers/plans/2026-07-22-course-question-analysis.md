...
- [ ] **Step 3: Add the Prisma model and Course relation**
...
- [ ] **Step 3: Resolve report ID on the server**
...
- [ ] **Step 4: Display the reference and pass the ID**
...
- [ ] **Step 5: Run linkage and existing question-generation tests**
...
- [ ] **Step 4: Check source and diff quality**
...
- [ ] **Step 5: Document API and commit final verification changes**
